    ...
    <>
      ...
      <div className="card">
        ...
        <p className="muted" style={{ marginTop: 0 }}>
          Эти поля сохраняют значения в <code>AppSettings</code>. Если вы оставите поле пустым,
          будет использован fallback из <code>appsettings.json</code> (если он задан).
        </p>
